    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          : ListView(
              children: [
                SizedBox(height: 20),
                CustomTextField(name, 'Group name'),
                Padding(
                  ...
                  children: [
                    _photo != null
                        ...
                        : ClipRRect(
                            borderRadius: BorderRadius.circular(90),
                            child: ImageWidget(
                                'https://cdn.discordapp.com/attachments/701544492448219257/1025160490114097192/helmi1.png',
                                90,
                                90)),
                    Positioned(
                        bottom: 0,
  ...
  createGroup() async {
    if (name.text == '') {
      ...
      if (_photo != null) {
        ...
        Reference reference =
            FirebaseStorage.instance.ref().child("groups/$id/icon/$imgId");
