...
class ShowGroupMessages extends StatefulWidget {
  final String id;
  ShowGroupMessages(this.id);
  @override
  State<ShowGroupMessages> createState() => _ShowGroupMessagesState();
}

class _ShowGroupMessagesState extends State<ShowGroupMessages> {
  ...
  deleteWidget(String id, String name) async {
    if (name != '') {
      await FirebaseStorage.instance
          .ref()
          .child("groups/${widget.id}/Messages/$name")
          .delete();
    }
